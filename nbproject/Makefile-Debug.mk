...
${OBJECTDIR}/logic/logic.o: logic/logic.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/logic/logic.o logic/logic.cpp

${OBJECTDIR}/logic/logic_processor.o: logic/logic_processor.cpp 
	${MKDIR} -p ${OBJECTDIR}/logic
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/logic/logic_processor.o logic/logic_processor.cpp
...
${OBJECTDIR}/parser/Absyn.o: parser/Absyn.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/parser/Absyn.o parser/Absyn.cpp

${OBJECTDIR}/parser/Printer.o: parser/Printer.cpp 
	${MKDIR} -p ${OBJECTDIR}/parser
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/parser/Printer.o parser/Printer.cpp

${OBJECTDIR}/parser/Skeleton.o: parser/Skeleton.cpp 
	${MKDIR} -p ${OBJECTDIR}/parser
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/parser/Skeleton.o parser/Skeleton.cpp

${OBJECTDIR}/parser/lexer.o: parser/lexer.cpp 
	${MKDIR} -p ${OBJECTDIR}/parser
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/parser/lexer.o parser/lexer.cpp
...
${OBJECTDIR}/parser/scope.o: parser/scope.cpp 
	${MKDIR} -p ${OBJECTDIR}/parser
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/parser/scope.o parser/scope.cpp

${OBJECTDIR}/parser/scope_inferrer.o: parser/scope_inferrer.cpp 
	${MKDIR} -p ${OBJECTDIR}/parser
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/parser/scope_inferrer.o parser/scope_inferrer.cpp

${OBJECTDIR}/parser/type.o: parser/type.cpp 
	${MKDIR} -p ${OBJECTDIR}/parser
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/parser/type.o parser/type.cpp

${OBJECTDIR}/parser/type_checker.o: parser/type_checker.cpp 
	${MKDIR} -p ${OBJECTDIR}/parser
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/parser/type_checker.o parser/type_checker.cpp
...
${TESTDIR}/tests/ShimmrTestRunner.o: tests/ShimmrTestRunner.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/ShimmrTestRunner.o tests/ShimmrTestRunner.cpp


${TESTDIR}/tests/scoper.o: tests/scoper.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/scoper.o tests/scoper.cpp


${TESTDIR}/tests/test_checker.o: tests/test_checker.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/test_checker.o tests/test_checker.cpp


${TESTDIR}/tests/tests.o: tests/tests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/tests.o tests/tests.cpp


${TESTDIR}/tests/type_axioms.o: tests/type_axioms.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/type_axioms.o tests/type_axioms.cpp
...
${OBJECTDIR}/logic/logic_nomain.o: ${OBJECTDIR}/logic/logic.o logic/logic.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/logic/logic_nomain.o logic/logic.cpp;\
	else  \
...
${OBJECTDIR}/logic/logic_processor_nomain.o: ${OBJECTDIR}/logic/logic_processor.o logic/logic_processor.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/logic/logic_processor_nomain.o logic/logic_processor.cpp;\
	else  \
...
${OBJECTDIR}/parser/Absyn_nomain.o: ${OBJECTDIR}/parser/Absyn.o parser/Absyn.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/parser/Absyn_nomain.o parser/Absyn.cpp;\
	else  \
...
${OBJECTDIR}/parser/Printer_nomain.o: ${OBJECTDIR}/parser/Printer.o parser/Printer.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/parser/Printer_nomain.o parser/Printer.cpp;\
	else  \
...
${OBJECTDIR}/parser/Skeleton_nomain.o: ${OBJECTDIR}/parser/Skeleton.o parser/Skeleton.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/parser/Skeleton_nomain.o parser/Skeleton.cpp;\
	else  \
...
${OBJECTDIR}/parser/lexer_nomain.o: ${OBJECTDIR}/parser/lexer.o parser/lexer.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/parser/lexer_nomain.o parser/lexer.cpp;\
	else  \
...
${OBJECTDIR}/parser/scope_nomain.o: ${OBJECTDIR}/parser/scope.o parser/scope.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/parser/scope_nomain.o parser/scope.cpp;\
	else  \
...
${OBJECTDIR}/parser/scope_inferrer_nomain.o: ${OBJECTDIR}/parser/scope_inferrer.o parser/scope_inferrer.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/parser/scope_inferrer_nomain.o parser/scope_inferrer.cpp;\
	else  \
...
${OBJECTDIR}/parser/type_nomain.o: ${OBJECTDIR}/parser/type.o parser/type.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/parser/type_nomain.o parser/type.cpp;\
	else  \
...
${OBJECTDIR}/parser/type_checker_nomain.o: ${OBJECTDIR}/parser/type_checker.o parser/type_checker.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/parser/type_checker_nomain.o parser/type_checker.cpp;\
	else  \
