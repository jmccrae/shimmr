...
ConditionalStatement::ConditionalStatement(LExpr *p1, Exp *p2, Exp *p3) { lexpr_ = p1; exp_1 = p2; exp_2 = p3; }
ConditionalStatement::ConditionalStatement(const ConditionalStatement & other) {   lexpr_ = other.lexpr_->clone();
...
ConditionalStatement::~ConditionalStatement() { delete(lexpr_); delete(exp_1); delete(exp_2); }
...
/********************   AbsoluteStatement    ********************/
AbsoluteStatement::AbsoluteStatement(LExpr *p1, Exp *p2) { lexpr_ = p1; exp_ = p2; }
AbsoluteStatement::AbsoluteStatement(const AbsoluteStatement & other) {   lexpr_ = other.lexpr_->clone();
  exp_ = other.exp_->clone();

}
AbsoluteStatement &AbsoluteStatement::operator=(const AbsoluteStatement & other) {
  AbsoluteStatement tmp(other);
  swap(tmp);
  return *this;
}
void AbsoluteStatement::swap(AbsoluteStatement & other) {
  std::swap(lexpr_, other.lexpr_);
  std::swap(exp_, other.exp_);

}

AbsoluteStatement::~AbsoluteStatement() { delete(lexpr_); delete(exp_); }

void AbsoluteStatement::accept(Visitor *v) { v->visitAbsoluteStatement(this); }
AbsoluteStatement *AbsoluteStatement::clone() const {
  return new AbsoluteStatement(*this);
}

/********************   ExpAsStatement    ********************/
ExpAsStatement::ExpAsStatement(Exp *p1) { exp_ = p1; }
ExpAsStatement::ExpAsStatement(const ExpAsStatement & other) {   exp_ = other.exp_->clone();
...
ExpAsStatement::~ExpAsStatement() { delete(exp_); }

void ExpAsStatement::accept(Visitor *v) { v->visitExpAsStatement(this); }
...
/********************   EFuncDecl    ********************/
EFuncDecl::EFuncDecl(Ident p1, ListArgument *p2, StatementBlock *p3) { ident_ = p1; listargument_ = p2; statementblock_ = p3; }
EFuncDecl::EFuncDecl(const EFuncDecl & other) {   ident_ = other.ident_;
...
/********************   EFuncDeclWithType    ********************/
EFuncDeclWithType::EFuncDeclWithType(Type *p1, Ident p2, ListArgument *p3, StatementBlock *p4) { type_ = p1; ident_ = p2; listargument_ = p3; statementblock_ = p4; }
EFuncDeclWithType::EFuncDeclWithType(const EFuncDeclWithType & other) {   type_ = other.type_->clone();
  ident_ = other.ident_;
  listargument_ = other.listargument_->clone();
  statementblock_ = other.statementblock_->clone();
...
EFuncDeclWithType::~EFuncDeclWithType() { delete(type_); delete(listargument_); delete(statementblock_); }

void EFuncDeclWithType::accept(Visitor *v) { v->visitEFuncDeclWithType(this); }
...
void ElseFailStat::accept(Visitor *v) { v->visitElseFailStat(this); }
...
/********************   EType    ********************/
EType::EType(Ident p1) { ident_ = p1; }
EType::EType(const EType & other) {   ident_ = other.ident_;
...
void EType::accept(Visitor *v) { v->visitEType(this); }
EType *EType::clone() const {
  return new EType(*this);
}

/********************   VectorType    ********************/
VectorType::VectorType(Type *p1, Type *p2) { type_1 = p1; type_2 = p2; }
VectorType::VectorType(const VectorType & other) {   type_1 = other.type_1->clone();
...
VectorType::~VectorType() { delete(type_1); delete(type_2); }
...
/********************   RangeType    ********************/
RangeType::RangeType(Integer p1, Integer p2) { integer_1 = p1; integer_2 = p2; }
RangeType::RangeType(const RangeType & other) {   integer_1 = other.integer_1;
...
void RangeType::accept(Visitor *v) { v->visitRangeType(this); }
RangeType *RangeType::clone() const {
  return new RangeType(*this);
}

/********************   SetType    ********************/
SetType::SetType(ListSetTypeElem *p1) { listsettypeelem_ = p1; }
SetType::SetType(const SetType & other) {   listsettypeelem_ = other.listsettypeelem_->clone();
...
SetType::~SetType() { delete(listsettypeelem_); }

void SetType::accept(Visitor *v) { v->visitSetType(this); }
SetType *SetType::clone() const {
  return new SetType(*this);
}

/********************   EIntSTE    ********************/
EIntSTE::EIntSTE(Integer p1) { integer_ = p1; }
EIntSTE::EIntSTE(const EIntSTE & other) {   integer_ = other.integer_;
...
void EIntSTE::accept(Visitor *v) { v->visitEIntSTE(this); }
EIntSTE *EIntSTE::clone() const {
  return new EIntSTE(*this);
}

/********************   EFloatSTE    ********************/
EFloatSTE::EFloatSTE(Double p1) { double_ = p1; }
EFloatSTE::EFloatSTE(const EFloatSTE & other) {   double_ = other.double_;
...
void EFloatSTE::accept(Visitor *v) { v->visitEFloatSTE(this); }
EFloatSTE *EFloatSTE::clone() const {
  return new EFloatSTE(*this);
}

/********************   EStringSTE    ********************/
EStringSTE::EStringSTE(String p1) { string_ = p1; }
EStringSTE::EStringSTE(const EStringSTE & other) {   string_ = other.string_;
...
void EStringSTE::accept(Visitor *v) { v->visitEStringSTE(this); }
EStringSTE *EStringSTE::clone() const {
  return new EStringSTE(*this);
}

/********************   ListSetTypeElem    ********************/
ListSetTypeElem::ListSetTypeElem(SetTypeElem *p1, ListSetTypeElem *p2) { settypeelem_ = p1; listsettypeelem_ = p2; }
ListSetTypeElem::ListSetTypeElem(const ListSetTypeElem & other) {   settypeelem_ = other.settypeelem_->clone();
  listsettypeelem_ = other.listsettypeelem_->clone();

}
ListSetTypeElem &ListSetTypeElem::operator=(const ListSetTypeElem & other) {
  ListSetTypeElem tmp(other);
  swap(tmp);
  return *this;
}
void ListSetTypeElem::swap(ListSetTypeElem & other) {
  std::swap(settypeelem_, other.settypeelem_);
  std::swap(listsettypeelem_, other.listsettypeelem_);

}

ListSetTypeElem::~ListSetTypeElem() { delete(settypeelem_); delete(listsettypeelem_); }
ListSetTypeElem::ListSetTypeElem(SetTypeElem *p)
{
  settypeelem_ = p;
  listsettypeelem_= 0;
}
ListSetTypeElem* ListSetTypeElem::reverse()
{
  if (listsettypeelem_ == 0) return this;
  else
  {
    ListSetTypeElem *tmp = listsettypeelem_->reverse(this);
    listsettypeelem_ = 0;
    return tmp;
  }
}

ListSetTypeElem* ListSetTypeElem::reverse(ListSetTypeElem* prev)
{
  if (listsettypeelem_ == 0)
  {
    listsettypeelem_ = prev;
    return this;
  }
  else
  {
...
void ListSetTypeElem::accept(Visitor *v) { v->visitListSetTypeElem(this); }
ListSetTypeElem *ListSetTypeElem::clone() const {
  return new ListSetTypeElem(*this);
}

/********************   VarAsLExpr    ********************/
VarAsLExpr::VarAsLExpr(Ident p1) { ident_ = p1; }
VarAsLExpr::VarAsLExpr(const VarAsLExpr & other) {   ident_ = other.ident_;

}
VarAsLExpr &VarAsLExpr::operator=(const VarAsLExpr & other) {
  VarAsLExpr tmp(other);
  swap(tmp);
  return *this;
}
void VarAsLExpr::swap(VarAsLExpr & other) {
  std::swap(ident_, other.ident_);

}

VarAsLExpr::~VarAsLExpr() { }

void VarAsLExpr::accept(Visitor *v) { v->visitVarAsLExpr(this); }
VarAsLExpr *VarAsLExpr::clone() const {
  return new VarAsLExpr(*this);
}

/********************   VectorAsLExpr    ********************/
VectorAsLExpr::VectorAsLExpr(LExpr *p1, ListExp *p2) { lexpr_ = p1; listexp_ = p2; }
VectorAsLExpr::VectorAsLExpr(const VectorAsLExpr & other) {   lexpr_ = other.lexpr_->clone();
  listexp_ = other.listexp_->clone();

}
VectorAsLExpr &VectorAsLExpr::operator=(const VectorAsLExpr & other) {
  VectorAsLExpr tmp(other);
  swap(tmp);
  return *this;
}
void VectorAsLExpr::swap(VectorAsLExpr & other) {
  std::swap(lexpr_, other.lexpr_);
  std::swap(listexp_, other.listexp_);

}

VectorAsLExpr::~VectorAsLExpr() { delete(lexpr_); delete(listexp_); }

void VectorAsLExpr::accept(Visitor *v) { v->visitVectorAsLExpr(this); }
VectorAsLExpr *VectorAsLExpr::clone() const {
  return new VectorAsLExpr(*this);
}
