...
void Skeleton::visitConditionalStatement(ConditionalStatement* conditionalstatement)
{
  ...
  visitIdent(conditionalstatement->ident_);
...
void Skeleton::visitFloatType(FloatType* floattype)
{
  /* Code For FloatType Goes Here */

}

void Skeleton::visitStringType(StringType* stringtype)
{
...
void Skeleton::visitAnythingType(AnythingType* anythingtype)
{
  /* Code For AnythingType Goes Here */

}

void Skeleton::visitNothingType(NothingType* nothingtype)
{
  /* Code For NothingType Goes Here */

}

void Skeleton::visitUnitType(UnitType* unittype)
{
